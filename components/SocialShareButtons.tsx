...
export function SocialShareButtons({
    ...
    let CREATE_DISCUS_ON_TWITTER =
        process.env.NEXT_PUBLIC_CREATE_DISCUS_ON_TWITTER;
    let CREATE_DISCUS_ON_GITHUB =
        process.env.NEXT_PUBLIC_CREATE_DISCUS_ON_GITHUB;
        ...
        <div className="items-center justify-between pb-6 pt-6 text-sm text-gray-700 dark:text-gray-300 md:flex">
            <div className="mb-6 md:mb-0">
                ...
                {CREATE_DISCUS_ON_GITHUB === "TRUE" && (
                    <Link
                        href={creatEditOnGithubUrl(fileName)}
                        className="hover:underline"
                    >
                        {"View on GitHub"}
                    </Link>
            ...
            <div className="flex items-center text-white">
                {SHARE_ON_TWITTER === "TRUE" && (
                    ...
                    >
                        ...
                        />
                        <span className="ml-2.5 mr-1.5 font-extrabold text-white">
                            Tweet
                        </span>
                    </TwitterShareButton>
                )}
